!(function () {
  "use strict";
  var s = {
    "scripts/annotator.bundle.js": "scripts/annotator.bundle.js?eb8f51",
    "styles/annotator.css": "styles/annotator.css?118e76",
    "styles/annotator.css.map": "styles/annotator.css.map?f470c6",
    ...
    "styles/sidebar.css": "styles/sidebar.css?e88409",
    "styles/sidebar.css.map": "styles/sidebar.css.map?877309",
    "styles/ui-playground.css": "styles/ui-playground.css?a7c5d5",
    "styles/ui-playground.css.map": "styles/ui-playground.css.map?80cb5a",
    "scripts/annotator.bundle.js.map": "scripts/annotator.bundle.js.map?4538e8",
    "scripts/sidebar.bundle.js": "scripts/sidebar.bundle.js?da1300",
    "scripts/ui-playground.bundle.js": "scripts/ui-playground.bundle.js?caf63d",
    "scripts/ui-playground.bundle.js.map":
      "scripts/ui-playground.bundle.js.map?dbeb55",
    "scripts/sidebar.bundle.js.map": "scripts/sidebar.bundle.js.map?1e6954",
  };
  function t(s) {
  ...
  function r(s, e, n, r) {
    ...
    (o.rel = e),
      (o.href = r),
      (o.type = "application/annotator+".concat(n)),
      t(o),
  ...
  function o(s, e, n) {
    ...
    (r.rel = "preload"),
      (r.as = e),
      (r.href = n),
      "fetch" === e && (r.crossOrigin = "anonymous"),
      t(r),
  ...
  function a(s) {
    ...
    return (s = (s = s.replace("{current_host}", e.hostname)).replace(
      "{current_scheme}",
      e.protocol,
    ));
  }
  if (
    ...
    var l = (function (s) {
        for (
          var t = {},
            e = s.querySelectorAll("script.js-hypothesis-config"),
            n = 0;
          n < e.length;
          n++
        ) {
      ...
      c = a(l.assetRoot || "https://cdn.hypothes.is/hypothesis/1.1367.0/");
    if (document.querySelector("hypothesis-app")) {
      !(function (s, t) {
        ...
        for (var r = 0, a = ["scripts/sidebar.bundle.js"]; r < a.length; r++)
          n(s, i(t, a[r]), { esModule: !0 });
        for (
          var l = 0, c = ["styles/katex.min.css", "styles/sidebar.css"];
          l < c.length;
          l++
        )
          e(s, i(t, c[l]));
      ...
      !(function (s, t) {
        if (!s.querySelector('link[type="application/annotator+html"]')) {
          r(s, "sidebar", "html", t.sidebarAppUrl),
            r(s, "notebook", "html", t.notebookAppUrl),
            r(s, "profile", "html", t.profileAppUrl),
            o(s, "style", i(t, "styles/annotator.css")),
            r(
              s,
              "hypothesis-client",
              "javascript",
          ...
          for (
            ...
            n(s, i(t, l[a]), { esModule: !1 });
          var c = [];
          void 0 !== window.PDFViewerApplication &&
            c.push("styles/pdfjs-overrides.css"),
