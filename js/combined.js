...
function openExternal() {
  document.getElementById("content-wrapper").style.width = "60%";
  document.getElementById("ext-wrapper").style.width = "40%";
...
function closeExternal() {
  ...
  document.getElementById("open-external").style.display = "inline-block";
}
...
function openSidebar() {
  document.getElementById("content-wrapper").style.marginLeft = "300px";
  document.getElementById("side-wrapper").style.width = "300px";
