...
<h1>🕊️ <b>O Evangelho segundo o Espiritismo</b></h1>

| ⚠️ **AVISO** |
|---|
| A obra original (ISBN 978-85-7328-730-1) *Copyright* © 1944 by Federação Espírita Brasileira) sofreu pequenas alterações de formato para melhor servir ao propósito deste projeto. |
...
📃 Nota explicativa](#ESE-2-01)
Índice Geral](#ESE-2-02)
